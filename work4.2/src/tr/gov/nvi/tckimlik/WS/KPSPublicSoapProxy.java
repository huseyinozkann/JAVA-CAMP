...
public class KPSPublicSoapProxy implements tr.gov.nvi.tckimlik.WS.KPSPublicSoap {
  ...
  public boolean TCKimlikNoDogrula(String string, java.lang.String ad, java.lang.String soyad, LocalDate i) throws java.rmi.RemoteException{
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
    return kPSPublicSoap.TCKimlikNoDogrula(string, ad, soyad, i);
  }
